...
vector<vector<operation>> create_next_generations(const vector<vector<operation>> &states, const vector<die_pattern> &dies, ll die_type, ll max_candidates=1, double grow_rate=0.01)
{
...
vector<operation> apply_beam_search(ll max_steps=1, ll die_type, ll max_candidates=1, double grow_rate=0.01)
{
